...
function quickAddWhatsappReply() {
  ...
  // ردود واتساب الفعلية كما وصلت حرفياً — بما فيها نص الترحيب
  // والأسطر الفارغة. لا تحذف شيئاً من رد العميل، المحلّل يتجاوز
  // كل ما ليس إجابة مرقّمة بنفسه.
  var replies = [
`حيّاك الله أبو بكر
...
2️⃣ عدد الطلبات/الفواتير: ٣٢
3️⃣ تكلفة البضاعة والتشغيل: ٦٠٠٠
4️⃣ عملاء جدد: ٢٠
5️⃣ عملاء متكررون: ١٢
...
1️⃣ إجمالي مبيعات اليوم (ريال): ٥٥٠٠
2️⃣ عدد الطلبات/الفواتير: ٣٥
3️⃣ تكلفة البضاعة والتشغيل: ٤٥٠٠
4️⃣ عملاء جدد: ٢٥
