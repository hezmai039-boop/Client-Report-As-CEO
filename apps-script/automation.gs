 ...
 *
 * الردود التي لا تطابق أي عميل مسجَّل (مثل "مطعم بيت الطهي" حالياً)
 * لا تُهمل بصمت، بل تُبلَّغ للفريق الداخلي.
 */
...
/**
 * دالة تسجيل سريعة — عدّل القيم وشغّلها لإضافة عميل في أقل من دقيقة.
 * مثال جاهز للعميل غير المسجَّل الذي وصلت بياناته بالفعل.
 */
function quickAddClient() {
  return onboardNewClient_(
      'مطعم بيت الطهي',   // الاسم — يجب أن يطابق ما يُكتب في النموذج حرفياً
      '',                  // بريد العميل
      'مطاعم',             // القطاع
      'مطعم بيت الطهي'     // الاسم الظاهر
  );
}
